...
public class ClockTest
{
    ...
    [Fact]
    public void Add_60_minutes()
    {
        var sut = new Clock(6, 0);
        Assert.Equal("07:00", sut.Add(60).ToString());
    }
    
    [Fact]
    public void Subtract_60_minutes()
    {
        var sut = new Clock(6, 0);
        Assert.Equal("05:00", sut.Subtract(60).ToString());
    }
